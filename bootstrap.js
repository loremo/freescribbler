...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "FreescribbleApp.controller.BestController": [],
  "FreescribbleApp.controller.EventController": [],
  "FreescribbleApp.controller.HomeController": [],
  "FreescribbleApp.controller.LoginController": [],
  "FreescribbleApp.controller.NewsController": [],
  "FreescribbleApp.controller.OptionsController": [],
  "FreescribbleApp.controller.SearchController": [],
  "FreescribbleApp.model.CommentModel": [],
  "FreescribbleApp.model.EventModel": [],
  "FreescribbleApp.model.PostModel": [],
  "FreescribbleApp.model.ProfileModel": [],
  "FreescribbleApp.model.UserModel": [],
  "FreescribbleApp.store.BestStore": [],
  "FreescribbleApp.store.EventStore": [],
  "FreescribbleApp.store.FriendsStore": [],
  "FreescribbleApp.store.HomeStore": [],
  "FreescribbleApp.store.NewsStore": [],
  "FreescribbleApp.store.ProfileStore": [],
  "FreescribbleApp.store.TagSearchStore": [],
  "FreescribbleApp.store.UserSearchStore": [],
  "FreescribbleApp.view.AddPost": [],
  "FreescribbleApp.view.BackTitleBarView": [],
  "FreescribbleApp.view.Best": [],
  "FreescribbleApp.view.BestListView": [],
  "FreescribbleApp.view.EventListView": [],
  "FreescribbleApp.view.Events": [],
  "FreescribbleApp.view.Home": [],
  "FreescribbleApp.view.HomeFollowersListView": [],
  "FreescribbleApp.view.HomeFriendsListView": [],
  "FreescribbleApp.view.HomePostsListView": [],
  "FreescribbleApp.view.HomeView": [],
  "FreescribbleApp.view.Login": [],
  "FreescribbleApp.view.LoginTabs": [],
  "FreescribbleApp.view.Main": [],
  "FreescribbleApp.view.News": [],
  "FreescribbleApp.view.NewsListView": [],
  "FreescribbleApp.view.Options": [],
  "FreescribbleApp.view.Registration": [],
  "FreescribbleApp.view.Search": [],
  "FreescribbleApp.view.TagSearchListView": [],
  "FreescribbleApp.view.Titlebarview": [],
  "FreescribbleApp.view.UserSearchListView": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "FreescribbleApp.view.HomeFollowersListView": [
    "widget.homefollowerslist"
  ],
  "FreescribbleApp.view.HomeFriendsListView": [
    "widget.homefriendslist"
  ],
  "FreescribbleApp.view.HomePostsListView": [
    "widget.homepostslist"
  ],
  "FreescribbleApp.view.HomeView": [
    "widget.homeview"
  ],
  ...
  "FreescribbleApp.view.Registration": [
    "widget.registrationtab"
  ],
  "FreescribbleApp.view.Search": [
    "widget.searchpage"
  ],
  "FreescribbleApp.view.TagSearchListView": [
    "widget.tagsearchlist"
  ],
  "FreescribbleApp.view.Titlebarview": [
    "widget.titlebarview"
  ],
